import { r as m, R as g, j as d } from './index-30b3ec0c.js';
var v = Object.defineProperty,
  ...
  h = (e, t, s) =>
    t in e
      ...
      : (e[t] = s),
  i = (e, t) => {
    for (var s in t || (t = {})) y.call(t, s) && h(e, s, t[s]);
    if (a) for (var s of a(t)) x.call(t, s) && h(e, s, t[s]);
    return e;
  },
  n = (e, t) => f(e, M(t)),
  O = class extends m.Component {
    constructor(e) {
      super(e), (this.ref = g.createRef()), (this.state = { style: {} });
      const t = {
        reverse: !1,
        max: 35,
        perspective: 1e3,
      ...
      return (
        ...
        this.setState(
          Object.assign({}, this.state, {
            style: n(i({}, this.state.style), { willChange: 'transform' }),
          }),
        ),
        this.setTransition(),
        e(t)
    ...
    setTransition() {
      clearTimeout(this.transitionTimeout),
        ...
        (this.transitionTimeout = setTimeout(() => {
          this.setState(
            Object.assign({}, this.state, {
              style: n(i({}, this.state.style), { transition: '' }),
            }),
          );
        }, this.settings.speed));
    }
    ...
    getValues(e) {
      const t = (e.nativeEvent.clientX - this.left) / this.width,
        ...
        u = r * 100,
        c = o * 100;
      return { tiltX: l, tiltY: p, percentageX: u, percentageY: c };
    }
    ...
    update(e) {
      ...
      this.setState(
        Object.assign({}, this.state, {
          style: n(i({}, this.state.style), {
            transform: `perspective(${this.settings.perspective}px) rotateX(${this.settings.axis === 'x' ? 0 : t.tiltY}deg) rotateY(${this.settings.axis === 'y' ? 0 : t.tiltX}deg) scale3d(${this.settings.scale}, ${this.settings.scale}, ${this.settings.scale})`,
          }),
        }),
      ),
        (this.updateCall = null);
